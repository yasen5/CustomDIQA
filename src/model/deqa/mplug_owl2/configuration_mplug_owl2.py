...
#
# Vendored, byte-for-byte, from the configuration_mplug_owl2.py shipped in the
# zhiyuanyou/DeQA-Score-Mix3 Hugging Face repo (the same file its
# modeling_mplug_owl2_huggingface.py / modeling_llama2.py / visual_encoder.py depend on).
import copy
import os
...
class LlamaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Not part of the original (2023-era) LlamaConfig this class is otherwise vendored
        # from -- added because transformers 4.46.3's LlamaMLP now reads config.mlp_bias
        # directly. LLaMA-2 never used an MLP bias, so False matches the actual checkpoint.
