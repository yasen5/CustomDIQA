...
#
# Vendored from the visual_encoder.py shipped in the zhiyuanyou/DeQA-Score-Mix3 Hugging Face
# repo, with one change: the `from icecream import ic` debug-print import is dropped (icecream
# isn't a dependency here, and `ic` is never actually called in this file).
import math
